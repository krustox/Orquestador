...
my $response = get $url;
$url ='http://vs2k8-monbdbc01/ConsultaOrquestador/Api.php?url=destinatarios&servicio=Nueva%20Intranet&tipo=Infraestructura&subservicio=Capa%20de%20Presentacion&site=Kenos&componente=Web&subcomponente=IIS&elemento=VS2K8-ICAPP02_IIS&segmento=NA&producto=NA&operacion=NA&variable=Conexiones%20Concurrentes&severidad=3'
print $url;
